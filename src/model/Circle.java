...
public class Circle extends Shape {
	...
	public Circle(double x1, double y1, double x2, double y2, Color color,
		...
		this.radius = Math.sqrt(Math.pow(getX2() - getX1(), 2)
	...
	protected java.awt.Shape getShape2D() {
		...
		java.awt.Shape oval = new Ellipse2D.Double(getX1(), getY1(), radius,
				radius);
	...
	protected Shape copyToHistory() {
		return new Circle(getX1(), getY1(), getX2(), getY2(), getColor(),
