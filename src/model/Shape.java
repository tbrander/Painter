...
public abstract class Shape implements Cloneable, Serializable {
	...
	public Shape(double x1, double y1, double x2, double y2, Color color,
	...
	protected void setShapeProperties(Color c, int lineThickness,
			boolean isFilled) {
		this.color = c;
	...
	protected void setNewShapeAttributes(double x1, double y1, double x2,
	...
	abstract protected void updateShape(Color c, int lineThickness,
			boolean isFilled);
